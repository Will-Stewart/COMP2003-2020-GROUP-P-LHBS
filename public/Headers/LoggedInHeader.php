<div class="shadow">
    <nav class="navbar navbar-expand-lg navbar-dark " style="background-color: #BF0A30;">
        <div class="navbar-collapse collapse w-150 order-1 order-md-0 dual-collapse2">
            ...
            <!--Navbar will display the Index, Create Booking, Manage Bookings and Support Page when the user logs in-->
            <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" style="align-items: center">
                        <a class="nav-link" href="../Volunteer/createBooking.php">Create Booking</a>
                    </li>

                    <li class="nav-item" style="align-items: center">
                        <a class="nav-link" href="../Volunteer/manageBookings.php">Manage Bookings</a>
                    </li>
    ...
    <!--Allow user to view profile and log out-->
    <ul class="navbar-nav mr-auto">
        <li class="nav-item" style="align-items: center">
            <a class="nav-link" href="../Volunteer/profile.php"><i class="fas fa-user-circle"></i> Profile: <?php echo $_SESSION['name']?></a>
        </li>
