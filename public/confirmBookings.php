...
<script type="text/javascript">
    ...
    $(document).ready(function($) {
        $("#table-row").click(function() {
            ...
            var tempBookingID = $("#table-row:first").val();
                    ...
                    <table class="table">
                        ...
                        if($result-> num_rows > 0){
                            while($row = $result-> fetch_assoc()){
                                echo "<tr id='table-row'><td>". $row["BookingID"] ."</td><td>". $row["First_Name"] ."</td><td>". $row["Last_Name"]. "</td><td>". $row["Booking_StartDate"]. "</td><td>". $row["Booking_EndDate"]."</td></t>";
                            }
                            echo "</table>";
                        }
                        else{
