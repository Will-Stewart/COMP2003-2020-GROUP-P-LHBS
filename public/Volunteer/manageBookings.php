...
$showUnconfirmed = "select BookingID, First_Name, Last_Name, Booking_StartDate, Booking_EndDate, Gender, Preferred_Room, Age, Price from comp2003_p.hostelbookings where Confirmation = 'Unconfirmed' && RegID = $id ";
$showConfirmed = "select BookingID, First_Name, Last_Name, Booking_StartDate, Booking_EndDate, Gender, Preferred_Room, Age, Price from comp2003_p.hostelbookings where Confirmation = 'Confirmed' && RegID = $id";
